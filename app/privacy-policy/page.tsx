...
export const metadata: Metadata = {
  title: 'Privacy Policy | Inspire LMS',
  description: 'How we handle your personal data at Inspire London College.',
};
    ...
    <div className="min-h-screen bg-gray-50 text-gray-800">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10 sm:py-14">
        ...
        <div className="space-y-6">
          <section className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
            ...
            <p className="text-gray-600 leading-relaxed mt-3">
              ...
              <a href="mailto:info@inspirelondoncollege.co.uk" className="text-[#11CCEF] hover:text-[#E51791] underline transition-colors">info@inspirelondoncollege.co.uk</a>
              {' '}OR by filling out our Contact Us form.
            </p>
          </section>
          ...
          <section className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
            ...
            <ul className="list-none space-y-1 text-gray-600">
              ...
              <li><strong className="text-gray-800">Email address:</strong>{' '}
                <a href="mailto:dpo@inspirelondoncollege.co.uk" className="text-[#11CCEF] hover:text-[#E51791] underline transition-colors">dpo@inspirelondoncollege.co.uk</a>
              </li>
          ...
          <section className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              <Link href="/cookie-policy" className="text-[#11CCEF] hover:text-[#E51791] underline transition-colors">Cookie Policy</Link>
          ...
          <section className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
            ...
            <p className="text-gray-600 leading-relaxed mt-3">
              ...
              <a href="https://ico.org.uk/for-organisations/guide-to-the-general-data-protection-regulation-gdpr/individual-rights/" target="_blank" rel="noopener noreferrer" className="text-[#11CCEF] hover:text-[#E51791] underline transition-colors break-all">
            ...
            <p className="text-gray-600 leading-relaxed mt-3">
              ...
              <a href="https://www.ico.org.uk" target="_blank" rel="noopener noreferrer" className="text-[#11CCEF] hover:text-[#E51791] underline transition-colors">www.ico.org.uk</a>
        ...
        <div className="mt-10 pt-6 border-t border-gray-200 flex flex-wrap gap-3">
          <Link href="/" className="inline-flex items-center gap-2 px-4 py-2 bg-[#E51791] hover:bg-[#c4127a] text-white font-medium rounded-lg transition-colors text-sm">
            ← Back to Home
          </Link>
          ...
          <Link href="/terms-and-conditions" className="inline-flex items-center px-4 py-2 border border-[#E51791] text-[#E51791] hover:bg-[#E51791] hover:text-white font-medium rounded-lg transition-colors text-sm">
            Terms & Conditions
          </Link>
        </div>
      </div>
