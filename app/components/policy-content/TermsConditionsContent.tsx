...
export default function TermsConditionsContent({ onNavigate, onClose }: TermsConditionsContentProps) {
  ...
  return (
    <div className="space-y-4 text-gray-800">
      <div className="mb-6 p-4 sm:p-6 bg-gray-50/50 rounded-lg">
      ...
      <div className="space-y-4">
        <details className="group bg-white rounded-lg border border-gray-200 overflow-hidden shadow-sm">
          ...
          <div className="px-4 pb-4 pt-0 space-y-4 text-gray-600 leading-relaxed border-t border-gray-100">
            ...
            <p>Following terms and conditions are essential to fulfilling by the learners if they register with Inspire London College (ILC) direct (from our website or through 3rd party website(s)).</p>
        ...
        <details className="group bg-white rounded-lg border border-gray-200 overflow-hidden shadow-sm">
          ...
          <div className="px-4 pb-4 pt-0 space-y-4 text-gray-600 leading-relaxed border-t border-gray-100">
            <ul className="list-disc list-inside space-y-2 text-sm">
              ...
              <li>For detailed information, please see our {onNavigate && onClose ? (
                <button type="button" onClick={() => handleInternalLink('/privacy-policy')} className="text-[#11CCEF] hover:text-[#E51791] underline transition-colors font-medium">
                  privacy policy
                </button>
              ) : (
                <span className="text-[#11CCEF] font-medium">privacy policy</span>
              )}.</li>
            </ul>
          </div>
        </details>
