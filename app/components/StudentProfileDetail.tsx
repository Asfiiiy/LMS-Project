          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                {student.learner_id && (
                  <p className="text-blue-50 text-sm font-medium mt-1">Learner ID: {student.learner_id}</p>
                )}
              </div>
            </div>
            <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div>
                  <label className="text-sm font-medium text-gray-500">Learner ID</label>
                  <p className="text-gray-900">{student.learner_id || 'Not provided'}</p>
                </div>
                <div>
            ...
            <div className="space-y-4 md:col-span-2">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {varkData.scores.map((score) => (
                  <div key={score.label} className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div className="text-2xl font-bold text-[#11CCEF]">{score.value}<span className="text-xs text-gray-400">/16</span></div>
                    <div className="mt-2 bg-gray-200 rounded-full h-2">
                      <div
                        className="bg-[#11CCEF] h-2 rounded-full"
                        style={{ width: `${(score.value / 16) * 100}%` }}
                      />
                    </div>
                  </div>
                ))}
              ...
              <div className="mt-4 p-3 bg-blue-50 rounded-lg">
                <p className="text-sm text-gray-700">
                  ...
                  {varkData.maxScore > 0 && ` (Score: ${varkData.maxScore}/16)`}
                </p>
              </div>
            </div>
