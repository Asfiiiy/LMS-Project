...
export default function FeedbackGivenPage() {
          ...
          {loading ? (
            <div className="flex items-center justify-center py-20">
              <div className="text-center">
                ...
                <p className="text-lg" style={{ color: '#1E1E1E60' }}>Loading feedback...</p>
              </div>
            </div>
          ) : totalSubmissions === 0 ? (
            <div className="text-center py-20">
              <p className="text-xl" style={{ color: '#1E1E1E60' }}>
                No feedback given today
              </p>
            </div>
          ) : (
            <>
                ...
                >
                  ...
                  <div className="flex items-start justify-between mb-4">
                    ...
                    {item.pass_fail_result && (
                      <span
                        ...
                        style={{
                          backgroundColor: item.pass_fail_result === 'Pass' ? '#12B7F38F' : '#FC98D3C9',
                          color: item.pass_fail_result === 'Pass' ? '#11CCEF' : '#E51791',
                        }}
                      >
                        {item.pass_fail_result}
                      </span>
                  ...
                  <div className="grid grid-cols-3 gap-6 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-base truncate" style={{ color: '#11CCEF' }}>
                        {item.file_name}
                      </p>
                    </div>
                    <div>
                  ...
                  <div className="grid grid-cols-2 gap-6 mb-4">
                    <div>
                      ...
                      <p className="text-base" style={{ color: '#1E1E1E' }}>
                        {new Date(item.graded_at).toLocaleString()}
                      </p>
                    </div>
                    <div>
                      <p className="text-xs font-semibold mb-1" style={{ color: '#1E1E1E60' }}>
                      ...
                      <p className="text-base font-medium" style={{ color: '#11CCEF' }}>
                        {item.graded_by_name}
                      </p>
                    </div>
                  </div>
                  ...
                  {item.feedback && (
                    <div>
                      <button
                        ...
                        style={{
                          backgroundColor: expandedFeedback[index] ? '#11CCEF20' : '#11CCEF10',
                          border: '1px solid #11CCEF30',
                        }}
                        onMouseEnter={(e) => {
                          if (!expandedFeedback[index]) {
                            e.currentTarget.style.backgroundColor = '#11CCEF15';
                          }
                        }}
                        onMouseLeave={(e) => {
                          e.currentTarget.style.backgroundColor = expandedFeedback[index] ? '#11CCEF20' : '#11CCEF10';
                        }}
                      >
                        <span className="text-sm font-semibold" style={{ color: '#11CCEF' }}>
                          📝 VIEW FEEDBACK
                        </span>
                        <svg
                          className={`w-5 h-5 transition-transform ${expandedFeedback[index] ? 'rotate-180' : ''}`}
                          style={{ color: '#11CCEF' }}
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                  ...
                  {/* Submission File */}
                  {item.file_path && (
                    <div className="mt-4 pt-4" style={{ borderTop: '1px solid #1E1E1E20' }}>
              ...
              {totalPages > 1 && (
                <div className="flex justify-center items-center gap-2 mt-6">
                  <button
                    ...
                    style={{
                      backgroundColor: page === 1 ? '#1E1E1E10' : '#228B22',
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    style={{
                      backgroundColor: page === totalPages ? '#1E1E1E10' : '#228B22',
